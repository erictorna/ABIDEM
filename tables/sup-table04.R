...
heading = fpar(ftext("Supplementary Table 3. Unadjusted and adjusted hazard ratios for haemorragic stroke and ABI category. Complete cases",
...
read_docx() %>%
  ...
  print(target = "www/sup-table04.docx")

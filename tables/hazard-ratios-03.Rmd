---
title: "Hazard ratios adjusted by variables given by Lia `r GROUP` group"
...
* Adjusted by: itb_cat + p.smoking + p.alcohol_high + p.diabetes + p.htn + p.dm_med + colldl + tg + p.ckd + 
               p.c02 + p.c03 + p.c07 + p.c08 + p.c09 + p.c10 + p.n06 + pspline(age, df=0)
...
library(huxtable)
library(data.table)
load(sprintf('hazard-ratios-03_%s.RData', GROUP))
